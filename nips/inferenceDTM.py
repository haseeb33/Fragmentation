...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 15 17:57:13 2020
...
ts = [] ;documents = []; prev = '1987' ; doc_count = 0 ; count = 0 ; y_ls = []
...
df2 = pd.DataFrame(distribution)
df2.to_excel(writer, "DTMDistribution")
writer.save()
